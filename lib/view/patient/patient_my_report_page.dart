...
import 'package:frontend_test/services/report_services.dart';
...
class PatientMyReportPage extends StatefulWidget {
  const PatientMyReportPage({super.key});

  @override
  State<PatientMyReportPage> createState() => _PatientMyReportPageState();
}

class _PatientMyReportPageState extends State<PatientMyReportPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: FutureBuilder(future: getMyReport(), builder: (context, snapshot) {
